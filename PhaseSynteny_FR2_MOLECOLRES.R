#PhaseSynteny_FR2_MOLECOLRES.R
#updated analysis of Canu genome assembly for De-Kayne, Zoller and Feulner 2020
...
chrom_order_df <- unique(lm$scaffold) 
chrom_order_df
missing <- c("scaffold7", "scaffold6", "scaffold37","scaffold38", "scaffold34", "scaffold39")
fullchroms <- c(chrom_order_df, missing)
chromosomes <- as.data.frame(fullchroms)
...
circos.clear()
#name of file/parameters
#tiff("FalconHi_C.vs.LinkageMap.tiff",height=8,width=8,units="in",res=300,compression="lzw")
# Customize plot parameters
par(fig=c(0,1,0,1),mar=c(1,1,1,1))
#create gaps vector
gapsnorm <- c(1)
...
collapsed <- read.csv("collapsedduplicates_FALCON.csv", header = TRUE)
...
circos.clear()
#name of file/parameters
tiff("/Users/rishidek/Dropbox/RishiMAC/Genome/PostPhaseScaffoldingFastas/FALCON_R2_HiC_vs_LM_MOLECOLRES_NEW.tiff",height=8,width=8,units="in",res=300,compression="lzw")
# Customize plot parameters
par(fig=c(0,1,0,1),mar=c(1,1,1,1))
#create gaps vector
gapsnorm <- c(1)
...
Snamevector <- c("FS40", "FS35", "FS39", "FS38", "FS07", "FS08", "FS14", "FS31", "FS06",
                 "FS36", "FS17", "FS05", "FS19", "FS37", "FS34", "FS28", "FS33", "FS32", 
                 "FS25", "FS24", "FS18", "FS23", "FS29", "FS20", "FS04", "FS11", "FS27", 
                 "FS26", "FS09", "FS30", "FS22", "FS10", "FS21", "FS16", "FS12", "FS13", "FS15", 
                 "FS02", "FS01", "FS03")
...
circos.track(factors = full_dat$segment, ylim = c(0,1), track.height = uh(1.5, "mm"),
             panel.fun = function(x, y) {
               if(grepl("FS", namevector[CELL_META$sector.numeric.index])){
...
#par(mfrow=c(1,1))
#par(mar=c(1,1,1,1))
tiff("/Users/rishidek/Dropbox/RishiMAC/Genome/PostPhaseScaffoldingFastas/FALCON_R2_coverage_40_MOLECOL.tiff",height=8,width=20,units="in",res=300,compression="lzw")
...
for (i in 0:39){
  ...
  over40 <- sum(cov_df_subset$V3 > 40)
  under40 <- sum(cov_df_subset$V3 < 41)
  cov_title = paste("FS", as.character((as.integer(i)+1)), sep = "")
  if(i%%10 == 0){
    ...
    if(scaffname == "scaffold0_"){
      rect(c(0), c(-2), c(55000000), 42, col = "lightgrey")
      points(cov_df_subset$V3 ~ cov_df_subset$V2, ylim = c(0,40), col=cov_df_subset$Colour)
    }
    if(scaffname == "scaffold1_"){
      rect(c(0), c(-2), c(13000000), 42, col = "lightgrey")
      points(cov_df_subset$V3 ~ cov_df_subset$V2, ylim = c(0,40), col=cov_df_subset$Colour)
    }
    if(scaffname == "scaffold1_"){
      rect(c(75000000), c(-2), c(max(cov_df_subset$V2)), 42, col = "lightgrey")
      points(cov_df_subset$V3 ~ cov_df_subset$V2, ylim = c(0,40), col=cov_df_subset$Colour)
    }
    if(scaffname == "scaffold2_"){
      rect(c(91000000), c(-2), c(max(cov_df_subset$V2)), 42, col = "lightgrey")
      points(cov_df_subset$V3 ~ cov_df_subset$V2, ylim = c(0,40), col=cov_df_subset$Colour)
    }
    if(scaffname == "scaffold4_"){
      rect(c(35000000), c(-2), c(60000000), 42, col = "lightgrey")
      points(cov_df_subset$V3 ~ cov_df_subset$V2, ylim = c(0,40), col=cov_df_subset$Colour)
    }
    if(scaffname == "scaffold5_"){
      rect(c(0), c(-2), c(44000000), 42, col = "lightgrey")
      points(cov_df_subset$V3 ~ cov_df_subset$V2, ylim = c(0,40), col=cov_df_subset$Colour)
    }
    if(scaffname == "scaffold5_"){
      rect(c(50000000), c(-2), c(65000000), 42, col = "lightgrey")
      points(cov_df_subset$V3 ~ cov_df_subset$V2, ylim = c(0,40), col=cov_df_subset$Colour)
    }
    if(scaffname == "scaffold6_"){
      rect(c(0), c(-2), c(30000000), 42, col = "lightgrey")
      points(cov_df_subset$V3 ~ cov_df_subset$V2, ylim = c(0,40), col=cov_df_subset$Colour)
    }
    if(scaffname == "scaffold6_"){
      rect(c(45000000), c(-2), c(max(cov_df_subset$V2)), 42, col = "lightgrey")
      points(cov_df_subset$V3 ~ cov_df_subset$V2, ylim = c(0,40), col=cov_df_subset$Colour)
    }
    if(scaffname == "scaffold17_"){
      rect(c(0), c(-2), c(20000000), 42, col = "lightgrey")
      points(cov_df_subset$V3 ~ cov_df_subset$V2, ylim = c(0,40), col=cov_df_subset$Colour)
    }
    if(scaffname == "scaffold19_"){
      rect(c(44000000), c(-2), c(max(cov_df_subset$V2)), 42, col = "lightgrey")
      points(cov_df_subset$V3 ~ cov_df_subset$V2, ylim = c(0,40), col=cov_df_subset$Colour)
    }
    ...
    if(scaffname == "scaffold2_"){
      rect(c(92000000), c(-2), c(max(cov_df_subset$V2)), 42, col = "lightgrey")
      points(cov_df_subset$V3 ~ cov_df_subset$V2, ylim = c(0,40), col=cov_df_subset$Colour)
    }
    if(scaffname == "scaffold4_"){
      rect(c(35000000), c(-2), c(60000000), 42, col = "lightgrey")
    ...
    if(scaffname == "scaffold5_"){
      rect(c(52000000), c(-2), c(67000000), 42, col = "lightgrey")
      points(cov_df_subset$V3 ~ cov_df_subset$V2, ylim = c(0,40), col=cov_df_subset$Colour)
    }
    if(scaffname == "scaffold6_"){
      rect(c(0), c(-2), c(30000000), 42, col = "lightgrey")
